...
export default function DashboardView(props: DashboardViewProps) {
  ...
  const { leftSidebarWidth, startLeftSidebarResize } =
          ...
          <div class="shrink-0">
            <Show when={showUpdatePill()}>
              ...
              >
                ...
                <span class="min-w-0 flex-1 truncate whitespace-nowrap text-left">
                  {updatePillLabel()}
                </span>
        ...
        <main class="min-w-0 flex-1 flex flex-col overflow-hidden rounded-[24px] border border-dls-border bg-dls-surface shadow-[var(--dls-shell-shadow)]">
          <div class="flex-1 overflow-y-auto">
            ...
            <div
              class={
                props.tab === "settings"
                  ? "w-full space-y-10 p-6 md:p-10"
                  : "mx-auto w-full max-w-[1100px] space-y-10 p-6 md:p-10"
              }
            >
              <Switch>
                <Match when={props.tab === "settings"}>
                  <SettingsView
                    ...
                    markOpencodeConfigReloadRequired={
                      props.markOpencodeConfigReloadRequired
                    }
            ...
            <ShareWorkspaceModal
              ...
              fields={shareFields()}
              remoteAccess={
                shareWorkspace()?.workspaceType === "local"
                  ? {
                      enabled:
                        props.openworkServerHostInfo?.remoteAccessEnabled ===
                        true,
